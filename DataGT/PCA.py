...
def dimensional_reduction(dataframe:pd.DataFrame,third_dimension:str,n_comp=4):
  ...
  X = dataframe.sample(5000)
  X_num = get_num(dataframe)
  X_features = X_num.columns

  standard_scaler = StandardScaler()
  X_scaled = standard_scaler.fit_transform(X_num)
  ...
  display_factorial_planes(X_projected, n_comp, pca, [(0,1),(2,3),(4,5)], illustrative_var=X[third_dimension].values)